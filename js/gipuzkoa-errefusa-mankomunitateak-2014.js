(function() {
    ...
    var herrialdeak = {
        "gipuzkoa": {
            kodea: 20,
            datuak: "datuak/gipuzkoa-birziklapena-mankomunitateak-2014.csv",
                ...
                .attr("fill", function(d) {
                    ...
                    if (d.properties.datuak) {
                        ...
                        if (d.properties.datuak.errefusa) {
                            ...
                            } else if (d.properties.datuak.errefusa > 100 && d.properties.datuak.errefusa <= 200) {
                                
                                return "#989898";
                                
                            } else if (d.properties.datuak.errefusa > 200 && d.properties.datuak.errefusa <= 300) {
